...
const education: EducationEntry[] = [
  {
    ...
    location: 'Iowa, USA',
    description:
      "Completed my Master's in Computer Science with a focus on AI and Machine Learning. Maintaining strong academic performance while working on cutting-edge projects in artificial intelligence and web development.",
    gpa: '3.83',
    points: [
  ...
  },
  {
    ...
    description:
      "Completed my Master's with distinction, specializing in Computer Vision and Machine Learning. Engaged in advanced research projects and collaborated with international teams.",
    gpa: '3.70',
    points: [
      'Computer Vision',
  ...
  },
  {
    ...
    description:
      "Completed my Bachelor's with distinction, specializing in Computer Vision and Machine Learning. Engaged in advanced research projects and collaborated with international teams.",
    gpa: '3.68',
    points: [
...
const experiences: ExperienceEntry[] = [
  {
    ...
    description:
      'Building perception systems spanning ToF drivers, real-time C++/Qt tracking, PyTorch training pipelines, ONNX deployment, and fleet-wide dataset orchestration for in-cabin driver monitoring.',
    points: [
  ...
  },
  {
    ...
    location: 'Remote',
    description:
      'Led development of a Svelte 5 wishlist platform with role-aware workflows for moms, agencies, and service providers, including starter-pack sharing and request-approval flows.',
    points: [
  ...
  },
  {
    ...
    description:
      'Go Global World is a platform that connects investors with startups. I worked on the AI team to develop AI-powered solutions for investor-founder matching and automated due diligence processes.',
    points: [
  ...
  },
  {
    ...
    location: 'Aksaray, Turkiye',
    description:
      'Orsan is a company that manufactures automotive parts for / under Mercedes-Benz. I worked on the R&D team to develop computer vision solutions for steel welding quality control.',
    points: [
  ...
  },
  {
    ...
    description:
      'TeknoWorld is a company that provides security solutions for variety of clients, such as houses, supermarkets and embassies. I worked on the R&D team to develop computer vision solutions for security cameras.',
    points: [
  ...
  },
  {
    ...
    location: 'Ventspils, Latvia',
    description:
      'Ventspils International Radio-Astronomy Center is the 8th largest radio telescope in the world. I worked on the R&D team to develop software solutions for radio astronomy.',
    points: [
...
const awards: AwardEntry[] = [
  ...
  },
  {
    ...
    date: 'Jun 2019',
    description:
      'Awarded to Bachelor alumni who have graduated with a 3.60 GPA as 3rd of the faculty by Aksaray University',
  },
  {
    ...
    date: 'Jun 2019',
    description:
      '"Egg Sex Classification with Morphological Methods" at the Food and Agriculture Category of 2242-University Students Research Project Competitions organized by TUBITAK Scientist Support Programs Presidency won the first prize in the Kayseri Regional Exhibition',
  },
  {
    ...
    description:
      'Awarded to graduate students who have been successful in the educational and professional area. Fee waiver + 7000 Euro / year grant',
  },
];
...
const projects: ProjectEntry[] = [
  {
    ...
    tags: [
      ...
      { name: 'LaTeX', color: 'blue-text-gradient' },
    ],
  ...
  },
  {
    ...
    tags: [
      ...
      { name: 'Benchmarking', color: 'blue-text-gradient' },
    ],
    image: chess_board,
    source_code_link: 'https://github.com/mucahitkayadan',
    live_project_link: 'https://github.com/mucahitkayadan',
  },
  {
    ...
    tags: [
      { name: 'RF', color: 'blue-text-gradient' },
      { name: 'CST', color: 'green-text-gradient' },
      { name: 'ADS', color: 'pink-text-gradient' },
    ],
    image: rf_energy_harvesting,
    source_code_link:
      'https://drive.google.com/file/d/1K8ISH88MuUDCK2jtg4DzetOhGanBCYat/view?usp=drive_link',
    live_project_link:
      'https://drive.google.com/file/d/1K8ISH88MuUDCK2jtg4DzetOhGanBCYat/view?usp=drive_link',
  },
  {
    ...
    tags: [
      ...
      { name: 'OmniPose', color: 'green-text-gradient' },
      { name: 'Palm API', color: 'pink-text-gradient' },
      { name: 'Pose Estimation', color: 'blue-text-gradient' },
    ],
    image: placeholder,
    source_code_link: 'https://github.com/mucahitkayadan',
    live_project_link: 'https://github.com/mucahitkayadan',
  },
  {
    ...
    tags: [
      { name: 'Kinect v2', color: 'blue-text-gradient' },
      { name: 'Kinect SDK', color: 'green-text-gradient' },
      { name: 'Pose Detection', color: 'pink-text-gradient' },
      { name: 'Motion Control', color: 'blue-text-gradient' },
    ],
    image: placeholder,
    source_code_link: 'https://github.com/mucahitkayadan',
    live_project_link: 'https://github.com/mucahitkayadan',
  ...
  },
  {
    ...
    tags: [
      { name: 'YOLO5', color: 'blue-text-gradient' },
      { name: 'Raspberry Pi', color: 'green-text-gradient' },
      { name: 'Object Detection', color: 'pink-text-gradient' },
      { name: 'IoT', color: 'blue-text-gradient' },
    ],
    image: placeholder,
    source_code_link: 'https://github.com/mucahitkayadan',
  ...
  },
  {
    ...
    tags: [
      { name: 'PLC', color: 'blue-text-gradient' },
      { name: 'Industrial Automation', color: 'green-text-gradient' },
      { name: 'HMI', color: 'pink-text-gradient' },
    ],
    image: placeholder,
    source_code_link: 'https://github.com/mucahitkayadan',
    live_project_link: 'https://github.com/mucahitkayadan',
  ...
  },
  {
    ...
    tags: [
      ...
      { name: 'LLM', color: 'green-text-gradient' },
      { name: 'Vector Search', color: 'pink-text-gradient' },
    ],
    image: placeholder,
    source_code_link: 'https://github.com/mucahitkayadan',
    live_project_link: 'https://github.com/mucahitkayadan',
  ...
  },
  {
    ...
    tags: [
      ...
      { name: 'NeRF', color: 'green-text-gradient' },
  ...
  },
  {
    ...
    tags: [
      ...
      { name: 'BMS', color: 'green-text-gradient' },
      { name: 'LiFePo4', color: 'pink-text-gradient' },
    ],
    image: placeholder,
    source_code_link: 'https://github.com/mucahitkayadan',
    live_project_link: 'https://github.com/mucahitkayadan',
...
export { experiences, awards, projects, education, testimonials };
